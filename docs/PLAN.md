...
escrita não bloqueia o scheduler. Há no máximo 16 workers simultâneos e cada
leitura/escrita expira em 250 ms; excesso é rejeitado. Erros transitórios do
tick são registrados e reprocessados com backoff limitado. A reconciliação
